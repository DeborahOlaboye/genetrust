...
it('returns 2d 23h ago for 71 hours ago', () => {
...
it('returns 6d 0h ago for 144 hours ago', () => {
...
it('returns 21d 0h ago for 504 hours ago', () => {
  expect(formatAuditTimestamp(Date.now() - 504 * 60 * 60 * 1000)).toBe('21d 0h ago');
});


it('returns unknown time for Date object with invalid timestamp string', () => {
  expect(formatAuditTimestamp(new Date('invalid'))).toBe('Unknown time');
});
...
it('returns 11d 12h ago for 276 hours ago', () => {
  expect(formatAuditTimestamp(Date.now() - 276 * 60 * 60 * 1000)).toBe('11d 12h ago');
});


it('returns 29d 0h ago for 696 hours ago', () => {
  expect(formatAuditTimestamp(Date.now() - 696 * 60 * 60 * 1000)).toBe('29d 0h ago');
});


it('returns 31d 0h ago for 744 hours ago', () => {
  expect(formatAuditTimestamp(Date.now() - 744 * 60 * 60 * 1000)).toBe('31d 0h ago');
});


it('returns 40d 0h ago for 960 hours ago', () => {
  expect(formatAuditTimestamp(Date.now() - 960 * 60 * 60 * 1000)).toBe('40d 0h ago');
});
