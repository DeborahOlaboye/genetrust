  ...
  return (
    <section className="relative py-20 bg-gradient-to-b from-[#14102E] to-[#000000] overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-3/4 left-1/3 w-64 h-64 bg-[#34D399]/5 rounded-full blur-2xl animate-pulse delay-500" />
      </div>
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-12 py-8">
            <div className="text-center">
              ...
              <div className="text-sm text-[#9AA0B2]">Active Users</div>
            </div>
            <div className="hidden sm:block w-px h-12 bg-[#2DD4BF]/20" />
            <div className="text-center">
              <div className="text-3xl font-bold text-[#F472B6] mb-1">$2.5M+</div>
              <div className="text-sm text-[#9AA0B2]">Earnings Distributed</div>
            </div>
            <div className="hidden sm:block w-px h-12 bg-[#2DD4BF]/20" />
            <div className="text-center">
              <div className="text-3xl font-bold text-[#34D399] mb-1">500+</div>
              <div className="text-sm text-[#9AA0B2]">Research Projects</div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            <button className="px-8 py-4 text-[#34D399] border border-[#34D399]/30 rounded-lg hover:bg-[#34D399]/5 hover:border-[#34D399]/50 transition-all duration-300 min-w-[180px]">
              Watch Demo
            </button>
          </div>
